...
class GroupMeBot(object):
    ...
    def parse_and_post(self, data):
        ...
        # non system messages not originating from upbot
            ...
            if text is not None:
                ...
                if when_where is not None:
                    if str(bot_name) in ['test-upbot', 'upbot']:
    ...
    def is_when_where(self, match, text):
        """
        Response for asking upbot when or where for calendar query.
        """
    ...
    def is_agenda(self, match, text):
        """
        Response for asking upbot for agenda.
        """
...
class UpbotServer(object):
    """
    Simple server for the upbot.
    """
    def __init__(self):
        """
        Set server up.
    ...
    def shutdown(self, signun, frame):
        """
        Gracefully shuts down flask server and upbot.
